...
var PixelMapper = (function () {
    ...
    PixelMapper.prototype.init = function () {
        ...
        this.mapping[94] = { index: 272, range: 4 };
        this.mapping[95] = { index: 368, range: 4 };
    };
    PixelMapper.prototype.resolve = function (coordinate) {
        if (coordinate.x < 0 || coordinate.x > 11 || coordinate.y < 0 || coordinate.y > 7) {
            throw new Error("Invalid coordinate");
        }
        var index = coordinate.x + coordinate.y * view_1.View.WIDTH;
        return this.mapping[index];
    };
    return PixelMapper;
}());
exports.PixelMapper = PixelMapper;
